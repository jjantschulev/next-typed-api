...
export function codegen(
  ...
  const generateCode = (isClient: boolean) => `/* eslint-disable */
...
${
  isClient && reactQuery
    ...
    : 'import { makeApiRequestFunction, makeBuildUrlFunction } from "next-typed-api/client"'
}
${
  reactQuery && isClient
...
${isClient && reactQuery ? reactQueryFunctions.join('\n') : ''}
...
`;
  ...
  return {
    serverFile: generateCode(false),
    clientFile: generateCode(true),
  };
}
